...
public class Update {
    ...
    @Autowired
    UpdateRailroadStationService updateRailroadStationService;

    @RequestMapping(value = "/stations", method = RequestMethod.GET)
    @Consumes("application/json")
    public String getAllStations(ModelMap model) {
        long startTime = System.currentTimeMillis();
        Collection<RailroadStation> railroadStations = updateRailroadStationService.updateRailroadStation();
