...
import com.ticket.utils.CyrillicChar;
...
public class HuntCities {
    ...
    public static void main(String[] args) throws IOException {
        ...
        StationListWithSameTopTwoChars pojo = webResource.accept(MediaType.APPLICATION_JSON).get(StationListWithSameTopTwoChars.class);
